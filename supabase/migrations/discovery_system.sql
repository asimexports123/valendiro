...
CREATE INDEX idx_discovery_system_sources_status ON discovery_system_sources(status);
CREATE INDEX idx_discovery_system_sources_type ON discovery_system_sources(source_type);
CREATE INDEX idx_discovery_system_sources_last_fetched ON discovery_system_sources(last_fetched_at);
...
CREATE INDEX idx_discovered_articles_status ON discovered_articles(status);
CREATE INDEX idx_discovered_articles_source ON discovered_articles(source_id);
CREATE INDEX idx_discovered_articles_published ON discovered_articles(published_at DESC);
CREATE INDEX idx_discovered_articles_relevance ON discovered_articles(relevance_score DESC);
CREATE INDEX idx_discovered_articles_url ON discovered_articles(url);
...
CREATE INDEX idx_article_deduplication_url_hash ON article_deduplication(url_hash);
CREATE INDEX idx_article_deduplication_title_hash ON article_deduplication(title_hash);
CREATE INDEX idx_article_deduplication_last_seen ON article_deduplication(last_seen_at DESC);
...
CREATE INDEX idx_discovered_article_topics_article ON discovered_article_topics(discovered_article_id);
CREATE INDEX idx_discovered_article_topics_topic ON discovered_article_topics(topic_id);
CREATE INDEX idx_discovered_article_topics_confidence ON discovered_article_topics(confidence DESC);
...
CREATE INDEX idx_knowledge_extraction_queue_status ON knowledge_extraction_queue(status, priority, scheduled_at);
CREATE INDEX idx_knowledge_extraction_queue_article ON knowledge_extraction_queue(discovered_article_id);
CREATE INDEX idx_knowledge_extraction_queue_topic ON knowledge_extraction_queue(topic_id);
...
CREATE INDEX idx_discovery_schedule_next_run ON discovery_schedule(next_run_at);
CREATE INDEX idx_discovery_schedule_status ON discovery_schedule(status);
CREATE INDEX idx_discovery_schedule_source ON discovery_schedule(source_id);
...
CREATE INDEX idx_discovery_metrics_source ON discovery_metrics(source_id, metric_type, recorded_at DESC);
CREATE INDEX idx_discovery_metrics_type ON discovery_metrics(metric_type, recorded_at DESC);
