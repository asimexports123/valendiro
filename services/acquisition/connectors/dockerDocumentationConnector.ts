 ...
 * Docker Official Documentation Connector
 * 
 * Authoritative source for Docker containerization
...
export class DockerDocumentationConnector implements IConnector {
  readonly sourceType = "docker-docs";
  readonly version = "1.0.0";
  private readonly baseUrl = "https://docs.docker.com";
  ...
  validateSource(config: ConnectorConfig): boolean {
    return config.sourceType === "docker-docs" as any && !!config.sourceUrl;
  }
