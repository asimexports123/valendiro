 ...
 * Node.js Documentation Connector
 * 
 * Authoritative source for Node.js runtime
...
export class NodejsDocumentationConnector implements IConnector {
  readonly sourceType = "nodejs-docs";
  readonly version = "1.0.0";
  private readonly baseUrl = "https://nodejs.org/docs";
  ...
  validateSource(config: ConnectorConfig): boolean {
    return config.sourceType === "nodejs-docs" as any && !!config.sourceUrl;
  }
