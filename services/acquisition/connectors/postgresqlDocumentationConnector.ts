 ...
 * PostgreSQL Documentation Connector
 * 
 * Authoritative source for PostgreSQL database
...
export class PostgreSQLDocumentationConnector implements IConnector {
  readonly sourceType = "postgresql-docs";
  readonly version = "1.0.0";
  private readonly baseUrl = "https://www.postgresql.org/docs";
  ...
  validateSource(config: ConnectorConfig): boolean {
    return config.sourceType === "postgresql-docs" as any && !!config.sourceUrl;
  }
