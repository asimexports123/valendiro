 ...
 * Git Official Documentation Connector
 * 
 * Authoritative source for Git version control
...
export class GitDocumentationConnector implements IConnector {
  readonly sourceType = "git-docs";
  readonly version = "1.0.0";
  private readonly baseUrl = "https://git-scm.com/doc";
  ...
  validateSource(config: ConnectorConfig): boolean {
    return config.sourceType === "git-docs" as any && !!config.sourceUrl;
  }
