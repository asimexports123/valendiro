...
async function triggerCreateTopics() {
  console.log("Creating topics for orphan articles...\n");

  try {
    const response = await fetch(`${BASE_URL}/api/admin/legacy-create-topics`, {
      method: "POST",
      headers: {
    ...
    console.log(`Successfully created and linked: ${data.created_count}`);
