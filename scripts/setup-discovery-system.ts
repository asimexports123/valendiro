/**
 * Setup Discovery System
 * Creates the database schema and initializes the discovery system
 */
...
async function setupDiscoverySystem() {
  ...
  try {
    ...
    console.log("\nIf the exec_sql function doesn't exist, please apply the migration manually via the Supabase SQL Editor:");
