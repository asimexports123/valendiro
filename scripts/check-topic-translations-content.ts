/**
 * Check topic_translations content for machine-learning-basics
 */
...
async function main() {
  ...
  console.log("Topic Translation Content (first 3000 chars):");
  console.log("==============================================");
  console.log(translation.content.substring(0, 3000));
  console.log("\n\nHeadings found:");
  const headings = translation.content.match(/<h[1-6][^>]*>.*?<\/h[1-6]>/gi) || [];
