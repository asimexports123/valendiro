...
`;
  ...
  if (error) {
    ...
    // Since we can't use exec_sql, we'll need to apply this manually or use the Supabase dashboard
    console.log("Please apply the migration manually via Supabase dashboard or use the SQL:");
