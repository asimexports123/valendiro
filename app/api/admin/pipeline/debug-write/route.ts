...
export async function POST(request: Request) {
  ...
  return NextResponse.json({
    ...
    h2Count,
    h3Count,
    geminiCallCount: pipeline.geminiCallCount,
    ...
    hasConclusion: pipeline.qualityReport.hasConclusion,
    hasFAQ: pipeline.qualityReport.hasFAQ,
    metaTitle: pipeline.metaTitle,
    metaDescription: pipeline.metaDescription,
    secondaryKeywords: pipeline.seoFields.secondaryKeywords,
